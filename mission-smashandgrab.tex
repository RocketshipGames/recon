...
\cfbox{LimeGreen}{\begin{minipage}{6.5in}
  ...
  \item The user must be a model (not a marker) in base contact with a
    Tech-Coffin equipped with a Datacube.
...
%        receive a +3 MOD.
      ...
      \item The user makes a Normal WIP roll to extract the Datacube.
            Specialist Troops roll~+1B and one die of their player's
            choice is discarded.

      %Doctors and Paramedics receive a~+3 MOD on this WIP check.
...
\cfbox{LimeGreen}{\begin{minipage}{6.5in}
  ...
  \textsc{Requirements}
  \begin{squishitemize}
  \item The user must be a model (not a marker) in base contact with
    either a Datacube marker or a friendly troop equipped with a
    Datacube.
