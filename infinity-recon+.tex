...
% All mercenaries may be selected regardless of normal
...
\begin{recon}
  ...
  original RECON packet, and specific clarifications are made on
  multiple wounds and No Wound Incapacitation.
...
\cfbox{LimeGreen}{\begin{minipage}{6.5in}
  ...
  \medskip      
      ...
      \item If successful, the acting player connects the Antenna or
        Console (mark it appropriately).  If the other player had
        previously hacked it, they are no longer connected (remove any
        such marker).
...
\vfill
\centerline{\includegraphics[width=0.5\linewidth]{art/rifle.pdf}}
%\vfill
\vbox to 0pt{}
...
\begin{tabular}{C{0.75in}C{1.75in}C{0.5in}C{1.25in}L{2in}}
  ...
  \rowcolor{CornflowerBlue!10} 11--14  & Seize the Antennas & \pageref{mission:seizetheantennas} & 3 Antennas & Hack the transmitters.\\
