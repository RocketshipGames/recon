...
\begin{tabular}{L{5.85in}C{0.5in}C{0.25in}C{0.25in}}
  ...
  %%
  %% ----------------------------------------------
  Hold any Datacube at any time in the game. & 1 & $\Box$ & $\Box$ \\
  \rowcolor{CornflowerBlue!10} Hold any Datacube at the end of game turn~1. & 1 & $\Box$ & $\Box$ \\
  Hold any Datacube at the end of game turn~2. & 1 & $\Box$ & $\Box$ \\
  \rowcolor{CornflowerBlue!10} Hold any Datacube at the end of game turn~3. & 3 & $\Box$ & $\Box$ \\
