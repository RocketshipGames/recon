...
\cfbox{LimeGreen}{\begin{minipage}{6.5in}
  ...
  \begin{squishitemize}
  \item The user must be a Specialist Troop model (not a marker) in
    base contact with a friendly troop equipped with a Datacube or a
    Datacube marker.
...
% \missionrule{Control.} Whenever any of a player's models are equipped
% with at least one Datacube, that player is considered to control a
% Datacube at that time.

\missionrule{Control.} Players control a Datacube whenever any of
...
\begin{tabular}{L{5.85in}C{0.5in}C{0.25in}C{0.25in}}
  ...
  \rowcolor{CornflowerBlue!10} Control any Datacube at the end of game turn~1. & 1 & $\Box$ & $\Box$ \\
  Control any Datacube at the end of game turn~2. & 1 & $\Box$ & $\Box$ \\
  \rowcolor{CornflowerBlue!10} Control any Datacube at the end of game turn~3. & 3 & $\Box$ & $\Box$ \\
